					...
					<%@page import="java.io.FileNotFoundException, java.io.IOException" %>
						...
						<body>
							...
							<div>
								...
								<br>
								<% String BookPath=(String)request.getAttribute("bookpath"); List<String>
										...
										<table>
											...
											<tbody>
												<% for(String k:key){ JSONObject view=(JSONObject) jobj.get(k); String
													BookName=(String)view.get("title"); String
													BookAuthor=(String)view.get("author"); String
													BookPublish=(String)view.get("publisher"); String
													BookField=(String)view.get("field"); String
													Issued=(String)view.get("Issued"); %>
													<tr>
														<td>
															<%= BookName %>
														</td>
